...
import ast
aug_df=pd.read_csv("HSA_Faclon_Pred_Gen.csv")         #Change
print(aug_df.columns)
aug_df = aug_df.rename(columns={'Falcon_Pred': 'Pred'})    #Change
...
df2=pd.read_csv("Sarc_Aug_Faclon_Pred_Gen.csv")

df2 = df2[df2['Tweets'].isin(aug_df_f1['Tweets'])]
df2 = df2.rename(columns={'Falcon_Pred': 'Pred'})
